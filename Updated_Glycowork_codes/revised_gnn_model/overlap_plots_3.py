...
rank = 'Family'
X, rank, splits, class_list, _ = hierarchy_filter(data, rank = 'Family', min_seq = 5, wildcard_seed = False, wildcard_list = None,
...
# print(lib_size)
rank = 'Family'
X, rank, splits, class_list, _ = hierarchy_filter(data, rank = 'Family', min_seq = 5, 
                                                                wildcard_seed = False, 
                                                                wildcard_list = None,
                                                                wildcard_name = None, r = 0.1)
print(X.shape)
