...
train_x,  train_y, test_x,test_y, id_val, class_list, class_converter = hierarchy_filter(data, rank = 'immunogenicity', min_seq = 5, wildcard_seed = False, wildcard_list = None,
