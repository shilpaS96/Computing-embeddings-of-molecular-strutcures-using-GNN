...
rank = 'Kingdom'
X_out, _, _, class_list, class_converter = hierarchy_filter(data, rank = 'Kingdom', min_seq = 5, 
                                          wildcard_seed = False, 
                                        wildcard_list = None,
...
model_filename = f'models/best_{rank}_model.pth'
...
class_names = [reverse_converter[cls] for cls in y_list]
...
output_path = f'./revised_embeddings/output_{rank}_plot.png' 
